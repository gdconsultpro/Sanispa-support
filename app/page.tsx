      ...
      <section className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div>
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row">
            <ButtonLink href="/diagnostic?new=1">Démarrer un diagnostic</ButtonLink>
            <ButtonLink href="/espace-client" variant="secondary">Mon compte</ButtonLink>
            <ButtonLink href="/partenaire/connexion" variant="secondary">Partenaires</ButtonLink>
          </div>
        </div>
        ...
        ].map((item) => (<div key={item.title} className="flex gap-4 border-b border-sanispa-line pb-4 last:border-0 last:pb-0">
