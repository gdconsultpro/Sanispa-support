        ...
        try {
            ...
            const { error } = await supabase.auth.signUp({
                ...
                options: {
                    ...
                    data: { firstName: form.firstName, lastName: form.lastName, phone: form.phone, address: form.address, postalCode: form.postalCode, city: form.city, spaBrand: form.spaBrand, spaModel: form.spaModel, spaYear: form.spaYear }
                }
            });
            if (error)
                throw error;
