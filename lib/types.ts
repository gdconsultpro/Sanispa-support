export type ProblemType = "fuite" | "electrique" | "traitement-eau" | "pompe" | "chauffage" | "clavier-ecran" | "filtration" | "bruit-anormal" | "autre";
export type ChoiceType = "intervention" | "devis" | "remote";
export type PaymentPlan = "photo" | "guided" | "premium" | "water";
export type DiagnosticStatus = "nouvelle" | "en analyse" | "devis envoyé" | "RDV demandé" | "terminé" | "NEW" | "AVAILABLE" | "ASSIGNED" | "CLOSED" | "WATER_ANALYSIS";
